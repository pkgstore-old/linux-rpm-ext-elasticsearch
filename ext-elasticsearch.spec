...
%{__install} -Dp -m 0644 %{SOURCE10} \
  %{buildroot}%{_sysconfdir}/%{app}/%{app}.local.yml


%files
%attr(0700,%{user},%{group}) %dir %{d_data}/%{app}
%config %{_sysconfdir}/%{app}/%{app}.local.yml
...
* Thu Mar 14 2019 Package Store <pkgstore@pm.me> - 1.0.0-100
- Initial build.
